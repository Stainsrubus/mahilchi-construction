<script>
    ...
    const projects = [
      { id: 1, name: "Grand Hall", image: "/images/8.JPG" },
      { id: 2, name: "Elegant Stage", image: "/images/6.JPG" },
      { id: 3, name: "Modern Venue", image: "/images/5.JPG" },
      { id: 4, name: "Conference Center", image: "/images/4.JPG" },
      { id: 5, name: "Wedding Hall", image: "/images/3.JPG" },
      { id: 6, name: "Exhibition Space", image: "/images/2.JPG" },
    ];
  ...
  <div class="p-4 container mx-auto py-10 lg:py-20">
    {#each projects as project, index}
        ...
        <div class="w-full h-64 md:h-96 relative mb-4 overflow-hidden group" style="perspective: 1000px;">
          ...
          <div
            class="absolute bottom-0 right-0 w-[30%] h-[50%] bg-gray-200/90 backdrop-blur-sm text-primary flex items-center justify-center
                   transition-all duration-1000 ease-in-out transform-gpu shadow-2xl border-l-2 border-t-2 border-white/20 opacity-0
          ...
          >
            <h3 class="text-lg font-bold text-center px-2 transform group-hover:scale-110 transition-transform duration-300">
              {project.name}
            </h3>
          </div>
        </div>
     ...
     style="transform-origin: right center;"
            >
              <h3 class="text-sm font-bold text-center px-1 transform group-hover:scale-110 transition-transform duration-300">
                {projects[index].name}
              </h3>
            </div>
          </div>
