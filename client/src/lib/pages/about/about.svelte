<script lang="ts">
    ...
    import houseImage from "$lib/images/home3.webp";
    import tickIcon from "$lib/svg/tick.svg";
...
<svelte:head>
<link rel="preload" as="image" href={houseImage} />
</svelte:head>
                        ...
                        <Tabs.Content value="mission" class="mt-6 text-gray-600">
                            ...
                            <div class="grid grid-cols-2 gap-5 mt-6">
                                <div class="flex items-center">
                                    <img src={tickIcon} alt="" loading="lazy" />
                                ...
                                <div class="flex items-center">
                                    <img src={tickIcon} alt="" loading="lazy" />
                                    <span class="ml-2">Skilled & Dedicated Team</span>
                                </div>
                                <div class="flex items-center">
                                    <img src={tickIcon} alt="" loading="lazy" />
